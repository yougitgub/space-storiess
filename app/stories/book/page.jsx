...
// Import the long story text - we'll inline the text here to keep the page self-contained
const storyText = `It was a winter of sharp cold in northern Norway. Snow covered the land like an endless white page. The whole family gathered inside a small wooden cabin, and around the fireplace, the logs crackled warmly, filling the room with heat.
...
const images = ["https://final-project-repo-zeta.vercel.app/1.jpg"];
    ...
    <div className="min-h-screen relative">
      ...
      <main className="relative z-10 flex items-start justify-center py-20 px-4">
        <div className="max-w-6xl w-full">
          <h1 className="text-3xl text-center text-white mb-8">Aurora Nights — Book</h1>
          <BookReader storyText={storyText} images={images} approxCharsPerPage={1100} />
        </div>
      </main>
      <Footer />
    </div>
